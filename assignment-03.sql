...
-- 4
SELECT * FROM account;
SELECT * FROM account ORDER BY char_length(full_name) DESC LIMIT 1;
-- 5 
SELECT * FROM account WHERE department_id =3 ORDER BY char_length(full_name) DESC LIMIT 1;
-- 6 
SELECT * FROM `group`;
-- 7 
...
SELECT group_name FROM `group` WHERE created_date < "2019-12-20";
-- 8 
SELECT * FROM exam;
SELECT code FROM exam WHERE duration>=60 AND created_date < "2019-12-20";
-- 9
SELECT * FROM `group` ORDER BY created_date DESC LIMIT 5;
-- 10 
